...
public class CheetahUtil {
   ...
   * @return The equivalent distance in meters based on the gear ratio and conversion factor.
   *         The calculation divides the rotations by 6 (gear ratio) and multiplies by 
   *         the effective distance per rotation (0.005 * 30 meters).
   */
  public static double elevatorRotationToMeters(double rotations) {
    return rotations / 6.0 * (0.005 * 30);
  }
   ...
   *         The calculation multiplies the rotations by 360 and divides by the effective ratio,
   *         which is derived from the product of (1/8 * 18/64 * 24/90).
   */

...
public class ClimberInCommand extends Command {
  ...
  public void initialize() {
    m_subsystem.setSystemIdleState(m_subsystem.getrollerSystemIdleState(), climberIdleState.in);
  }
  ...
  public boolean isFinished() {
    return m_subsystem.getclimberSystemIdleState() == climberIdleState.in;
  }
}

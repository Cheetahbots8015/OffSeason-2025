...
public class ClimberOutCommand extends Command {
  ...
  public void initialize() {
    m_subsystem.setSystemIdleState(m_subsystem.getrollerSystemIdleState(), climberIdleState.out);
  }
  ...
  public boolean isFinished() {
    return m_subsystem.getclimberSystemIdleState() == climberIdleState.out;
  }
}
